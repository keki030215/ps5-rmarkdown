...
The *gapminder* dataset contains `r nrow(gapminder)` rows and `r ncol(gapminder)` columns.
...
There are 2 NA values, which means no country appears more than once, but NA value appears more than once.
...
There are 4 NA values in the country column, which means no country has more than one iso3-code, or we cannot know which countries have that.
...
Explanation: Before around 2005, the U.S. has the highest co2 emission, but after that, China has an sharp increase in CO2 emission and became the highest one. Botswana has the lowest CO2 emission. Germany has the most missing number of CO2 emission. ((Because Germany only has about half of a line compared with other countries in the graph)
...
Explanation: In this graph, I saw the U.S. has the highest emission, and Canada has the second highest CO2 emission among the six countries. India has the lowest emission overall, but Botswana was lower than India before 1970s. China has an sudden sharp increase around 2005. Germany has the most missing number of CO2 emissions. (Because Germany only has about half of a line compared with other countries in the graph)
...
Comment: I found that as the GDP per capita increases, the life expectancy shows a logarithmic growth. In general, Europe and Americas have the most GDP per capita and longest life expectancy, while Africa and Asia have the least of them. In terms of population, Asia has the most population.
...
In the two graphs, the GDP per capita and life expectancy both display a logarithmic growth. However, the main region of the most GDP per capita and longest life expectancy in 2016 changes from Europe and Americas to Europe, and the least changes from Asia and Africa to Africa. In the last 60 years, Europe still thrives, Americas regress a little bit, and Asia developed a lot. 
...
##### I understand the 1960-2019 in the instruction as "from 1960 to 2019", so I did for each year. 
```{r}
gapminder %>% 
...
Explanation: The life expectancy of Asia and Africa is increasing rapidly these years.
